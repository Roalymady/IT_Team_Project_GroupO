error id: file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java:_empty_/GameState#aiPlayer#
file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java
empty definition using pc, found symbol in pc: _empty_/GameState#aiPlayer#
...
private void moveAIUnitVisually(ActorRef out, GameState gameState, GameUnit unit, Tile targetTile) {
    ...
    private void executeAITurn(ActorRef out, GameState gameState) {
        ...
        // Phase 1: Draw
        for (int k = 0; k < 1; k++) {
            if (!gameState.ai@@Player.getDeck().isEmpty()) {
