error id: file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java:_empty_/MovementRule#isProvoked#
file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java
empty definition using pc, found symbol in pc: _empty_/MovementRule#isProvoked#
...
// [文件: events/EndTurnClicked.java]
    ...
    private GameUnit findBestTarget(GameState gameState, GameUnit attacker) {
        ...
        if (MovementRule.isProvok@@ed(gameState.board, attacker)) {
