error id: file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java:_empty_/BasicCommands#addPlayer1Notification#
file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java
empty definition using pc, found symbol in pc: _empty_/BasicCommands#addPlayer1Notification#
...
private boolean castSmartAIAbility(ActorRef out, GameState gameState, Card card) {
    ...
    if (name.equals("Beam Shock") || name.equals("Beamshock")) {
        ...
        if (target != null && maxAtk > 2) {
            BasicCommands.addPlayer1N@@otification(out, "AI Stuns!", 2);
