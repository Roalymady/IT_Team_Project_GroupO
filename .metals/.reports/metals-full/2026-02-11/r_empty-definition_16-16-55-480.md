error id: file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java:_empty_/BasicCommands#setUnitHealth#
file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java
empty definition using pc, found symbol in pc: _empty_/BasicCommands#setUnitHealth#
                    ...
                    for (int[] pos : checkPos) {
                        if (pos[0] >= 0 && pos[0] < gameState.board.getXMax()) {
                            ...
                            if (u != null && u.getOwner() == gameState.aiPlayer && !isAvatar(u)) {
                                ...
                                BasicCommands.setU@@nitHealth(out, u.getBasicUnit(), u.getCurrentHealth());
                            }
                        }
                    }
                }
