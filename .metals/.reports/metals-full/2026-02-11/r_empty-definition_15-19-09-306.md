error id: file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java:_empty_/BasicCommands#
file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java
empty definition using pc, found symbol in pc: _empty_/BasicCommands#
...
public void processEvent(ActorRef out, GameState gameState, JsonNode message) {
    ...
    for (int x = 0; x < gameState.board.getXMax(); x++) {
        ...
        // --- Your Turn ---
        BasicC@@ommands.addPlayer1Notification(out, "Your Turn!", 2);
