error id: file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java:_empty_/GameUnit#getMaxHealth#
file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java
empty definition using pc, found symbol in pc: _empty_/GameUnit#getMaxHealth#
                    ...
                    for (int[] pos : checkPos) {
                        if (pos[0] >= 0 && pos[0] < gameState.board.getXMax()) {
                            ...
                            if (u != null && u.getOwner() == gameState.aiPlayer && !isAvatar(u)) {
                                ...
                                u.setMaxHealth(u.g@@etMaxHealth() + 1);
