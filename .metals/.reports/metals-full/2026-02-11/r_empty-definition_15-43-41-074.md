error id: file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java:_empty_/GameState#aiPlayer#getBasicPlayer#
file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java
empty definition using pc, found symbol in pc: _empty_/GameState#aiPlayer#getBasicPlayer#
        ...
        for (int i = gameState.aiPlayer.getHand().size() - 1; i >= 0; i--) {
            ...
            if (gameState.aiPlayer.getMana() >= card.getManacost()) {
                ...
                if (played) {
                    ...
                    gameState.aiPlayer.getBasicPla@@yer().setMana(gameState.aiPlayer.getMana());
                    BasicCommands.setPlayer2Mana(out, gameState.aiPlayer.getBasicPlayer());
