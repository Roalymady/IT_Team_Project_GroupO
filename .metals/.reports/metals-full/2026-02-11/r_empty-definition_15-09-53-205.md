error id: file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java:_empty_/GameState#board#getUnitAt#
file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java
empty definition using pc, found symbol in pc: _empty_/GameState#board#getUnitAt#
...
private void moveAIUnitVisually(ActorRef out, GameState gameState, GameUnit unit, Tile targetTile) {
    ...
    if (Math.abs(diffX) + Math.abs(diffY) == 2) {
        ...
        // 斜向移动 (1,1)
            ...
            if (gameState.board.getUnit@@At(t1.getTilex(), t1.getTiley()) == null) {
                intermediate = t1;
            } else {
