error id: file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java:_empty_/GameState#aiPlayer#getMaxMana#
file:///D:/Doneload/ITSD-DT2025-26-Template/app/events/EndTurnClicked.java
empty definition using pc, found symbol in pc: _empty_/GameState#aiPlayer#getMaxMana#
...
public void processEvent(ActorRef out, GameState gameState, JsonNode message) {
    ...
    for (int x = 0; x < gameState.board.getXMax(); x++) {
        ...
        if (gameState.aiPlayer.getMaxMa@@na() > 9) gameState.aiPlayer.setMaxMana(9);
